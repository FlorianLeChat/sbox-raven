...
public class InventoryBar : Panel
{
	...
	private static readonly List<InventoryIcon> slots = new();
	...
	private static void SetActiveSlot( InputBuilder input, IBaseInventory inventory, int index )
	{
		var player = Local.Pawn;
		if ( player == null )
			return;

		var ent = inventory.GetSlot( index );
	...
	private static void SwitchActiveSlot( InputBuilder input, IBaseInventory inventory, int offset )
	{
